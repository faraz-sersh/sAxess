...
public struct RLP {
    ...
    public static func encode(_ item: Any) -> Data? {
        switch item {
        case let value as Int: return encodeInt(value)
        case let value as Int64: return encodeInt64(value)
        case let value as String: return encodeString(value)
        case let value as BigInt: return encodeBigInt(value)
        case let value as [Any]: return encodeArray(value)
        case let value as BigUInt: return encodeBigUInt(value)
        case let value as Data: return encodeData(value)
        case let value as EthereumAddress: return encodeAddress(value)
        default: return nil
        }
    }

    static func encodeString(_ string: String) -> Data? {
        return encodeData(string.toHex())
    }
    ...
    static func encodeInt64(_ int: Int64) -> Data? {
        guard int >= 0 else {
            return nil
        }
        return encodeBigInt(BigInt(int))
