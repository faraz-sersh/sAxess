  ...
  getSershBalance() async {
    try {
      ...
      if (address.value.isNotEmpty) {
        ...
        final contractAddress = EthereumAddress.fromHex("0xF579C0b725F956eb4D70d2B07af4CA8985AFE39f".toLowerCase());
        ...
        final bal = await client.call(contract: contract, function: contract.function("balanceOf"), params: params);
        print(bal);
